...
@Component({
    template: `
  <h2 highlight="yellow">Something Yello</h2>
...
describe('HighlightDirective', () => {
    ...
    it('should have HighlightDirective in the 1st <h2> providerTokens', () => {
        expect(des[0].providerTokens).toContain(HighlightDirective);
    });

    it('should not have `HighlightDirective` in the 3rd <h2> providerTokens', () => {
